...
void RenderFunction(void)
{
	...
	// In cazul in care este folosita glutReshapeFunc proiectia trebuie actualizata in functia de desenare
...
int main(int argc, char* argv[])
{
	...
	glutCreateWindow("Cerc cu disc - reprezentare parametrica");		//	Creeaza fereastra de vizualizare, indicand numele acesteia;
